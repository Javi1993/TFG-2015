...
public class Comunicacion {
	...
	private static final String targetURL = "http://localhost:8080/aplicacion/rest/heartbeat";
	private int cnt;
	private Timer timer;
	...
	public static String heartBeat ()
	{
		try {
			...
			MessageRQ messageRQ = new MessageRQ(Long.toString((long) Math.random()*999999999+100000000), "IAMALIVE", "SIMULACION");
		...
		public void run() {
			...
			{//no recibio respuesta del FRONT-END o esta fue erronea
				...
				{//mandamos email notificando del comportamiento del receptor
					Funciones.sendEmail("TFG: Aplicación web no responde", "<!DOCTYPE html><html><head><meta charset='utf-8'></head><body>"
							...
							+ "<p>El servidor de simulaciones intenta comunicarse con la aplicaci&oacute;n web pero no recibe respuesta o esta no es correcta. Revise su estado con urgencia.</p>"
