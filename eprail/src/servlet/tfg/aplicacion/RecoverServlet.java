...
public class RecoverServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextPage = "/errors/404.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{//mandamos email para recuperar cuenta
			...
			if(user!=null)
			{//existe el usuario
				Funciones.sendEmail("TFG: Restablecer contraseña","<!DOCTYPE html><html><head><meta charset='utf-8'></head><body>"
						...
						+ "http://localhost:8080/aplicacion/recover?op="+user.getUid()+"&em="+Funciones.cryptMD5("0021"+user.getEmail())+
